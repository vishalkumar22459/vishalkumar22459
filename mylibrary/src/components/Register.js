                        ...
                        <div className="card">
                            <div className="card-header">Register
                                ...
                                <form name="my-form" onsubmit="return validform()" action="success.php" method="">
                                        ...
                                        <div className="form-group row">
                                            <label for="phone_number" className="col-md-4 col-form-label text-md-right">Phone Number</label>
                                            <div className="col-md-6">
                                        ...
                                        <div className="form-group row">
                                            <label for="present_address" className="col-md-4 col-form-label text-md-right">Present Address</label>
                                            <div className="col-md-6">
                                        ...
                                        <div className="form-group row">
                                            <label for="permanent_address" className="col-md-4 col-form-label text-md-right">Permanent Address</label>
                                            <div className="col-md-6">
